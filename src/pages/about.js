...
const AboutPage = () => (
  <Layout>
    ...
    <section>
      <h2 className="mb-0 py-2 text-3xl font-bold text-center leading-tight">
    ...
    <section>
      ...
      <p>You can support us by supporting our local restaurants!</p>
      <h3 className="mb-0 py-2 text-2xl font-bold text-center leading-tight">
      ...
      <p>
        ...
        <a href="paypal.me/taylorpage">buy us a coffee</a>. You can also refer
        us to your friends and family who have website and online needs that we
        can possibly help with to send some work our way. We love supporting
        local businesses and we're doing fine in all this. So if this is one
        small way we can help right now, we're here for it.
      </p>
    </section>
