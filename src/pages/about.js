    ...
    <div className="mx-auto md:max-w-screen-lg">
      <section>
        ...
        <p className="py-2">
          ...
          <a href="https://thepagesmedia.com">The Pages Media</a> designed to
          help promote local restaurants in the Springfield, MO area. The goal
          of this project is to make it simple for patrons to identify and
          support local restaurants. This list excludes chains, franchises, and
          other larger restaurant brands that may have more supports than our
          local eateries. The goal here is to support our neighbors and friends
          and link people to the best the 417 area has to offer.
        </p>
      </section>
      <section>
        ...
        <p className="py-2">
          ...
          need to support our neighbors. Other large establishments may have
          other resources at their disposal in tough times but our friends and
          neighbors who are struggling to keep their business afloat need our
          help.
        </p>
        <p className="py-2">
      ...
      <section>
        ...
        <p className="py-2">
          Taylor and Kendra Page, a local Springfield area couple who freelance
          in web development and design and other online solutions for small
          businesses and churches. We wanted to find some way to give back and
          make it easy for people to support local.
        </p>
      </section>
      <section>
        <h2 className="py-2 text-3xl font-bold text-center leading-tight">
        ...
        <p className="py-2">
          ...
          supported for as long as this state of emergency is our reality. We
          hope one day it can grow and possibly turn into more, but for now it
          will continue to be available as a resource for local patrons to
          easily find the best local places in our area.
        </p>
        <p className="py-2">
          You can support us by supporting our local restaurants! Submit updated
          info if you find something wrong. It's hard to keep track of over 200
          eating establishments and we certainly cannot do it on our own.
        </p>
      </section>
      <section>
        ...
        <p className="py-2">
          ...
          all this. You can support us by supporting our local businesses. If
          this is one small way we can help right now, we're here for it. Maybe
          consider buying a gift card if a local business has this option or
          choose to "pay it forward" to a family in need. You can also refer us
          to your friends and family who have website and online needs.
        </p>
        <p className="py-2">
